...
| `braun` | Braun / Dieter Rams · 迪特·拉姆斯风 | Minimal, Classic | Industrial design company sites | — |
...
| `bauhaus` | Bauhaus · 包豪斯 | Art, Vintage, Classic | Contemporary art gallery sites | — |
| `scandinavian` | Scandinavian · 斯堪的纳维亚 | Minimal, Warm | Home furniture brand sites | — |
...
| `japanese` | Japanese Minimalism · 日式极简 | Minimal, Classic, Warm | Japanese restaurant websites | — |
...
| `memphis` | Memphis · 孟菲斯 | Art, Playful, Vintage | Kids brands and educational products | — |
| `art-deco` | Art Deco · 装饰艺术 | Classic, Vintage | Luxury jewelry brands | — |
| `glassmorphism` | Glassmorphism · 玻璃拟态 | Modern, Trendy, Hot | SaaS dashboards and consoles | 3 Hard |
| `dark-academia` | Dark Academia · 暗黑学院 | Classic, Vintage | Independent publishers and bookstores | — |
| `pixel` | Pixel Art · 像素风 | Vintage, Playful, Distinctive | Indie game studios | 2 Medium |
| `cyberpunk` | Cyberpunk · 赛博朋克 | Avant-garde, Distinctive | Game websites and esports brands | — |
...
| `vaporwave` | Vaporwave · 蒸汽波 | Art, Vintage | Retro electronic music projects | — |
...
| `anti-design` | Anti-Design · 反设计 | Avant-garde, Distinctive, Trendy | Gen Z streetwear brands | — |
| `neumorphism` | Neumorphism / Soft UI · 新拟态 | Modern, Minimal | Concept design and Dribbble showcases | — |
