...
- `glassmorphism` **Glassmorphism** (玻璃拟态) — Modern, Trendy, Hot

### 🛍️ E-commerce / Retail / 电商 / 零售
...
### 🧸 Kids / Education / 儿童 / 教育

- `claymorphism` **Claymorphism** (粘土拟态) — Modern, Playful
- `memphis` **Memphis** (孟菲斯) — Art, Playful, Vintage
- `organic` **Organic Design** (有机形态) — Modern, Playful
