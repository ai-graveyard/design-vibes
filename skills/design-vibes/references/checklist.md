...
Run through this before handing a styled page back to the user. Most items come from real breakage found while building and testing the 30 reference demos across two browser engines.
