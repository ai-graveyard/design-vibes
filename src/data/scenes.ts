...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    styleIds: ['swiss', 'bento', 'scandinavian', 'maximalism', 'anti-design'],
  },
  {
    id: 'creative',
    icon: '🎨',
    ...
    styleIds: ['swiss', 'bauhaus', 'kinetic', 'neo-brutalism', 'editorial', 'braun', 'neumorphism'],
  },
  {
    id: 'enterprise',
    icon: '🏢',
    ...
    styleIds: ['material', 'flat', 'swiss', 'apple', 'braun'],
  },
  {
    id: 'culture',
    icon: '🏛️',
...
export const difficultyTiers: DifficultyTier[] = [
  {
    ...
    name: '简单',
    nameEn: 'Easy',
    styleIds: ['flat', 'duotone', 'brutalism', 'neo-brutalism', 'terminal', 'scandinavian'],
  },
  {
    level: 2,
    name: '中等',
